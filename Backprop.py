...
class Classifier:
    ...
    def train(self, train_data, train_fact, epoch=50, learning_rate=0.1, hidden_layer=[0], output_layer=1):
...
def main():
    ...
    # Classifier
    clf = Classifier()
    clf.train(train.data, train.fact, epoch=50, learning_rate=0.1, hidden_layer=[2, 3, 2])
